...
const DEVICES = [
  ...
  },
  {
    ...
    callouts: [
      ...
      ['shells', 'Fusion layers', 'Optical, acoustic and satellite streams, read together', -20, 75, null, 1],
      ['rings', 'Analytics', 'Occupancy, density and abundance, always current', 20, 75, null, 1],
      ['swarm', 'Detections', 'Every alert from the field network, streamed live', -20, -45, null, 1],
