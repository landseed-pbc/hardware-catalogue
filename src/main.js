...
const DEVICES = [
  {
    ...
    callouts: [
      ...
      ['shell', 'Camo shell', 'IP67+ · tested underwater', -35, -100],
    ],
  },
  {
  ...
  },
  {
    ...
    callouts: [
      ['lens', 'Optics', 'VillageGuard 2 MP platform', -22, -110],
      ['pod', 'Acoustic pod', 'The listening half of the survey', -45, -10, 'above'],
      ['ai', 'Bespoke models', 'The key species of your landscape', 165, -5],
      ['wifi', 'Wi-Fi offload', 'No airtime required', 49, -28, null, 1],
    ],
  },
  {
  ...
  },
  {
    ...
    callouts: [
      ...
      ['shells', 'Fusion layers', 'Optical, acoustic and satellite streams, read together', 0, 65, null, 1],
      ['rings', 'Analytics', 'Occupancy, density and abundance, always current', 0, 65, null, 1],
      ['swarm', 'Detections', 'Every alert from the field network, streamed live', 0, -40, null, 1],
      ['base', 'Back to the sources', 'Alerts and reports return to the teams in the field', 0, -40, null, 1],
    ],
  },
];
